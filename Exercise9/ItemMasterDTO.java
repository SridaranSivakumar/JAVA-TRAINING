...
public class ItemMasterDTO implements Serializable, Comparable<ItemMasterDTO> {
	...
	public String toString() {
		return "ItemMasterDTO [itemno=" + itemno + ", itemname=" + itemname + ", itemprice=" + itemprice + ", unit="
				+ unit + "]";
	}

	public ItemMasterDTO(int itemno, String itemname, int itemprice, int unit) {
		this.itemno = itemno;
...
//		return Objects.(itemname, other.itemname) && itemno == other.itemno && itemprice == other.itemprice
